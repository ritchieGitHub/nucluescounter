...
public class CellCntrMarkerVector extends Vector<CellCntrMarker> {
	...
	private Color createColor(int typeID) {
		...
		default:
			...
			while (c.equals(Color.blue) | c.equals(Color.cyan) | c.equals(Color.green) | c.equals(Color.magenta)
					| c.equals(Color.orange) | c.equals(Color.pink) | c.equals(Color.red) | c.equals(Color.yellow)) {
